...
const myAddress = '0x75dE164aa2f83625def6257cC99d40C8C4f659d9'
...
async function main() {
    ...
    const delegationTx = await BallotContract.delegate(delegation);
    const delegationReceipt = await delegationTx.wait();
    console.log(`Tx hash is ${delegationReceipt.transactionHash} in block ${delegationReceipt.blockNumber}`);
